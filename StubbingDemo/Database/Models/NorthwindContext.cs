...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<CustomersWhoDidntOrder> CustomersWhoDidntOrders { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomersWhoDidntOrder>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomersWhoDidntOrder");
        ...
        {
            entity.HasKey(e => e.OrderDetailsId).HasName("PK_Order_Details");

            entity.ToTable("Order Details");

            entity.HasIndex(e => new { e.OrderId, e.ProductId }, "IX_Order Details").IsUnique();
        ...
        modelBuilder.Entity<VRandNumber>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vRandNumber");

            entity.Property(e => e.Randnumber).HasColumnName("randnumber");
        });
